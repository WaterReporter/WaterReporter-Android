package com.viableindustries.waterreporter.api.services;
...
//        if (mimeType == null) mimeType = "image/png";
        ...
        Report post = RestClient.getReportService().postReportSync(accessToken, "application/json", reportPostBody);
