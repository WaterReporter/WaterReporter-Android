...
//        postWatershed = (TextView) v.findViewById(R.id.postWatershed);
//        postCaption = (TextView) v.findViewById(R.id.postCaption);
//        ownerAvatar = (ImageView) v.findViewById(R.id.ownerAvatar);
//        postGroups = (FlexboxLayout) v.findViewById(R.id.postGroups);
