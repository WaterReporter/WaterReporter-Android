...
import com.viableindustries.waterreporter.data.objects.role.Role;
...
public class UserProperties implements Serializable {
    ...
    public Map<String, String> getStringProperties() {
        ...
        // Must account for existing users without profile pictures
        ...
        try {
            ...
            stringProperties.put("picture", null);
